...
export function getFallbackRecommendations(skills: string[], level: string, interest: string) {
  ...
  if (
    ...
    skills.some((s) =>
      ["react", "vue", "angular", "css", "html", "javascript", "typescript"].includes(
        s.toLowerCase(),
      ),
    )
  ) {
      ...
      repos: [
        {
          name: "github/docs",
          description:
            "The official open-source documentation for GitHub. Excellent first-contribution targets.",
          match: normalizedLevel === "beginner" ? "98%" : "85%",
          difficulty: "Beginner",
          reason:
            "This project provides straightforward Markdown documentation files, making it an excellent match for beginner-friendly content edits.",
          issues: [
        ...
        },
        {
          name: "vitejs/vite",
          description:
            "Next-generation frontend tooling. Very active community and friendly maintainers.",
          match: normalizedLevel === "intermediate" ? "92%" : "82%",
          difficulty: "Intermediate",
          reason:
            "Aligned to modern build tools using TypeScript, perfect for testing bundler asset cache performances.",
          issues: [
        ...
        },
        {
          ...
          description:
            "Beautiful & consistent icon toolkit made by the community. Excellent for standard icon fixes or design contributions.",
          match: "89%",
          difficulty: "Beginner",
          reason:
            "Lucide icons require simple SVG manipulations and standard React wrappers, which aligns well with basic components learning.",
          issues: [
    ...
    skills.some((s) =>
      ["node", "express", "python", "django", "java", "sql", "db"].includes(s.toLowerCase()),
    )
  ) {
    return {
      repos: [
        {
          ...
          description:
            "Fast, unopinionated, minimalist web framework for Node.js. The foundation of modern fullstack apps.",
          match: normalizedLevel === "beginner" ? "90%" : "85%",
          difficulty: "Beginner",
          reason:
            "Express is written in Javascript/Node, matching backend learners wanting to understand middleware routing stacks.",
          issues: [
        ...
        },
        {
          ...
          difficulty: "Intermediate",
          reason:
            "Perfect for Python developers interested in asynchronous request processing and type validations.",
          issues: [
        ...
        },
        {
          ...
          description:
            "Collection of Node.js modules for interfacing with PostgreSQL databases. Solid foundational backend tech.",
          match: "85%",
          difficulty: "Intermediate",
          reason:
            "Provides direct SQL query interfaces in Node.js, great for validating transaction pools and connection controls.",
          issues: [
    ...
    skills.some((s) =>
      ["python", "pytorch", "ml", "ai", "pandas", "numpy"].includes(s.toLowerCase()),
    )
  ) {
    return {
      repos: [
        {
          ...
          description:
            "Building applications with LLMs through composability. Extremely fast-moving open-source ecosystem.",
          match: normalizedLevel === "intermediate" ? "95%" : "80%",
          difficulty: "Intermediate",
          reason:
            "Enables developing AI agent flows and orchestrations using Python, matching modern AI/ML application tooling.",
          issues: [
        ...
        },
        {
          ...
          description:
            "The friendly PIL fork is an image processing library for Python. Ideal for learners with clear specs.",
          match: "88%",
          difficulty: "Beginner",
          reason:
            "An image helper library in Python requiring isolated drawing coordinates fixes, suitable for early learners.",
          issues: [
        ...
        },
        {
          ...
          description:
            "State-of-the-art Machine Learning for PyTorch, TensorFlow, and JAX. Highly regarded source repository.",
          match: "84%",
          difficulty: "Intermediate",
          reason:
            "The industry standard repository for pre-trained AI models, ideal for intermediate PyTorch learners.",
          issues: [
      ...
      repos: [
        {
          name: "docker/cli",
          description:
            "The official command line interface for Docker. Perfect for developers interested in virtualization and shell scripts.",
          match: "85%",
          difficulty: "Intermediate",
          reason:
            "Focuses on CLI parameter styling and WSL configurations, ideal for DevOps learners.",
          issues: [
        ...
        },
        {
          ...
          description:
            "Radically simple IT automation system. Excellent for learning configuration-as-code and infrastructure automation.",
          match: "82%",
          difficulty: "Intermediate",
          reason:
            "Written in Python, this project helps DevOps enthusiasts understand playbook scripting variables.",
          issues: [
        ...
        },
        {
          ...
          description:
            "A delightful community-driven framework for managing your zsh configuration. Fun first contribution opportunity.",
          match: "95%",
          difficulty: "Beginner",
          reason:
            "Requires shell script customizations and theme adjustments, very beginner-friendly for shell scripting.",
          issues: [
...
export function getFallbackExplanation(issueText: string) {
  ...
  if (hasGit) {
    return {
      meaning:
        "This issue focuses on correcting or updating the project deployment/setup pipeline or code version trackers. Users are facing issues initializing git repositories or submitting correct commits without breaking upstream rules.",
      files: [".github/workflows/deploy.yml", ".gitignore", "README.md"],
      steps: [
    ...
    return {
      meaning:
        "The repository requires fixing the docker image definition or container settings. A dependency package version is likely outdated or fails to download inside the sandboxed running environment.",
    ...
    return {
      meaning:
        "This is a styling bug in the application where responsive layouts are overlapping or failing contrast criteria on specific screens. It requires fixing broken tailwind layout classes or raw style metrics.",
      files: ["src/components/Dashboard.tsx", "src/index.css", "tailwind.config.js"],
      steps: [
    ...
    return {
      meaning:
        "This issue reports a functional error or warning during application boot or compilation. The current parameters are throwing unexpected exceptions under clean local test environments.",
...
export async function getLiveGitHubRecommendations(
  skills: string[],
  level: string,
  interest: string,
) {
