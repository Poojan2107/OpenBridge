...
export function HeroSection({ onConnectGuest }: HeroSectionProps) {
  ...
  return (
    <section className="relative pt-16 sm:pt-24 pb-28 border-b border-[#30363D] overflow-hidden">
      <div
        className="absolute top-0 left-10 w-full h-[500px] bg-[linear-gradient(to_right,#1f242c_1px,transparent_1px),linear-gradient(to_bottom,#1f242c_1px,transparent_1px)] bg-[size:32px_32px] [mask-image:radial-gradient(ellipse_60%_50%_at_20%_0%,#000_70%,transparent_100%)] opacity-35 pointer-events-none"
        aria-hidden="true"
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-6 space-y-8 text-center lg:text-left select-none">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#2F81F7]/10 border border-[#2F81F7]/35 rounded-full">
            ...
            <span className="text-xs font-mono uppercase tracking-wider text-[#58A6FF] font-bold">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#F0F6FC] leading-[1.05] font-sans">
              ...
              into{" "}
              <span className="bg-gradient-to-r from-[#2F81F7] via-[#58d5ff] to-[#39D353] text-transparent bg-clip-text">
                Open Source
              </span>
            </h1>
            <p className="text-[#8B949E] text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              OpenBridge helps developers discover repositories, understand issues with AI
              integration, and navigate contribution pathways like Hacktoberfest and GSOC.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-1">
            ...
            <button
              onClick={() =>
                document
                  .getElementById("ob-features-struggle")
          ...
          <div className="pt-4 border-t border-[#30363D]/60 max-w-sm mx-auto lg:mx-0">
            <span className="block text-xs font-mono uppercase text-[#8B949E] tracking-widest font-bold">
              GitHub OAuth — in active development
            </span>
          </div>
        </div>
        <div className="lg:col-span-6 animate-fade-in">
          <div className="bg-[#161B22] border border-[#30363D] rounded-lg overflow-hidden shadow-2xl relative">
            <div className="bg-[#0D1117] border-b border-[#30363D] px-4 py-3 flex items-center justify-between">
              <div
                className="flex items-center gap-1.5 select-none text-zinc-600"
                aria-hidden="true"
              >
            ...
            <div className="p-5 bg-[#0D1117] min-h-[290px] text-xs leading-relaxed select-none">
              {activeMockTab === "recs" && (
                <div className="space-y-3.5 animate-fade-in">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-mono text-[#8B949E] uppercase font-bold tracking-wider">
                      AI RECOMMENDATIONS
                    </span>
                    <span className="text-[11px] bg-[#238636]/15 hover:bg-[#238636]/30 text-[#39D353] border border-[#238636]/40 px-2 py-0.5 rounded font-mono font-bold">
                      2 matched repositories
                    </span>
                  </div>
                  <div className="border border-[#30363D] bg-[#161B22] rounded-md p-3.5 space-y-2 hover:border-[#8B949E]/60 transition-colors">
                    <div className="flex items-start justify-between">
                      <div className="space-y-0.5 min-w-0">
                        ...
                        <span className="block text-[11px] text-[#8B949E] truncate">
                          High Performance Context Management State Container
                        </span>
                      </div>
                      <button
                        onClick={() => {
                      ...
                      >
                        <Star
                          className={`w-3 h-3 ${mockStarred ? "fill-[#D29922] text-[#D29922]" : ""}`}
                        />
                    ...
                    <div className="flex items-center gap-3 text-[10px] font-mono text-[#8B949E]">
                      <span className="flex items-center gap-1">
                        <span
                          className="w-2 h-2 rounded-full bg-[#3178c6] block"
                          aria-hidden="true"
                        />{" "}
                        TypeScript
                      </span>
                      <span>Forks: 104</span>
                      <span className="px-1.5 py-0.1 bg-[#238636]/10 text-[#3fb950] border border-[#238636]/30 rounded text-[10px] font-bold uppercase">
                        Beginner Match 96%
                      </span>
                    </div>
                  </div>
                  <div className="border border-[#30363D] bg-[#161B22] rounded-md p-3.5 space-y-2">
                    <div className="flex items-start justify-between">
                      <div className="space-y-0.5 min-w-0">
                        ...
                        <span className="block text-[11px] text-[#8B949E] truncate">
                          Dynamic server-side asset encoding middleware
                        </span>
                      </div>
                    ...
                    <div className="flex items-center gap-3 text-[10px] font-mono text-[#8B949E]">
                      <span className="flex items-center gap-1">
                        <span
                          className="w-2 h-2 rounded-full bg-[#f1e05a] block"
                          aria-hidden="true"
                        />{" "}
                        JavaScript
                      </span>
                      <span>Forks: 42</span>
                      <span className="px-1.5 py-0.1 bg-[#58A6FF]/10 text-[#58A6FF] border border-[#58A6FF]/20 rounded text-[10px] font-bold uppercase">
                        Intermediate Match
                      </span>
                    </div>
                  </div>
              ...
              {activeMockTab === "roadmap" && (
                <div className="space-y-3.5 animate-fade-in">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-mono text-[#8B949E] uppercase font-bold tracking-wider">
                      GUIDED 4-WEEK ASSIGNMENT
                    </span>
                    <span className="text-[11px] text-[#8B949E] font-mono">
                      Week 1 Active Progress: 50%
                    </span>
                  </div>
                  <div className="border border-[#30363D] bg-[#161B22] rounded-md divide-y divide-[#30363D] overflow-hidden">
                    <div
                      className="p-3 bg-[#1c2128] font-mono text-xs font-semibold text-[#F0F6FC]"
                      aria-label="Week 1 milestone"
                    >
                      Environment Readiness & GPG Check
                    </div>
                    <div
                      ...
                      role="checkbox"
                      aria-checked={!!mockCheckedTasks["week1-0"]}
                      tabIndex={0}
                      onKeyDown={(e) => {
                        if (e.key === "Enter" || e.key === " ") {
                          e.preventDefault();
                          handleToggleMockTask("week1-0");
                        }
                      }}
                    >
                      <div
                        className={`w-4 h-4 rounded-sm border mt-0.5 flex items-center justify-center transition-all ${mockCheckedTasks["week1-0"] ? "bg-[#238636] border-[#2ea44f]" : "border-[#30363D] bg-[#0D1117]"}`}
                      >
                      ...
                      <div>
                        <span
                          className={`block font-semibold text-xs ${mockCheckedTasks["week1-0"] ? "line-through text-[#8B949E]" : "text-[#F0F6FC]"}`}
                        >
                          GPG Cryptographic Key Signature Validation
                        </span>
                        <span className="block text-[11px] text-[#8B949E]">
                          Construct a secure GPG sign-off key on the pre-flight console
                        </span>
                      </div>
                    </div>
                    <div
                      ...
                      className="p-3 flex items-start gap-2.5 hover:bg-[#21262d]/50 cursor-pointer transition-colors"
                      role="checkbox"
                      aria-checked={!!mockCheckedTasks["week1-1"]}
                      tabIndex={0}
                      onKeyDown={(e) => {
                        if (e.key === "Enter" || e.key === " ") {
                          e.preventDefault();
                          handleToggleMockTask("week1-1");
                        }
                      }}
                    >
                      <div
                        className={`w-4 h-4 rounded-sm border mt-0.5 flex items-center justify-center transition-all ${mockCheckedTasks["week1-1"] ? "bg-[#238636] border-[#2ea44f]" : "border-[#30363D] bg-[#0D1117]"}`}
                      >
                      ...
                      <div>
                        <span
                          className={`block font-semibold text-xs ${mockCheckedTasks["week1-1"] ? "line-through text-[#8B949E]" : "text-[#F0F6FC]"}`}
                        >
                          Inspect codebase hierarchy
                        </span>
                        <span className="block text-[11px] text-[#8B949E]">
                          Fork and download entry scripts on the integrated editor tool
                        </span>
                      </div>
                    </div>
                  </div>
                  <p className="text-xs font-mono text-[#8B949E] text-center">
                    Check items to interactively trigger roadmap state progression.
                  </p>
                </div>
              )}
              {activeMockTab === "issue" && (
                <div className="space-y-3.5 animate-fade-in">
                  ...
                  <div className="space-y-2.5">
                    <div className="bg-[#161B22] border border-[#30363D] p-3 rounded-md">
                      <label
                        htmlFor="mock-translate-input"
                        className="block text-[10px] font-mono uppercase text-[#F85149] font-bold mb-1"
                      >
                        Raw Bug Log Input
                      </label>
                      <input
                    ...
                    <div className="bg-[#161B22] border border-[#30363D] p-3 rounded-md space-y-1.5 font-mono text-xs">
                      <span className="block text-[10px] uppercase text-[#39D353] font-bold">
                        Gemini Context Parsing
                      </span>
                      <p className="text-[#F0F6FC] font-semibold">
                        Diagnosis: Standard Bootstrap Crash
                      </p>
                      <p className="text-[#8B949E] leading-relaxed">
                        The function <code className="text-[#f78166]">bootstrapTelemetry()</code>{" "}
                        tries to load variables but the main workstation config dictionary is
                        missing or unresolved.
                      </p>
                      <div className="text-[11px] text-[#58A6FF] font-semibold flex items-center gap-1 mt-1">
                        <CheckCircle className="w-3.5 h-3.5 text-[#39D353]" /> Action Item: Check
                        environmental config variables in server file.
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-2.5">
                    <div className="border border-[#124429] bg-[#1f242c]/65 p-3 rounded-md flex items-center justify-between">
                      <div className="space-y-0.5">
                        <span className="font-semibold text-xs text-[#39D353] block">
                          PR #14: Link authorized GitHub signature block
                        </span>
                        <span className="text-[11px] text-[#8B949E] block">
                          Target branch: master &bull; guest-committer
                        </span>
                      </div>
                      <span className="px-2 py-0.5 font-mono bg-[#238636]/20 text-[#39D353] border border-[#238636]/40 rounded text-[10px] font-bold uppercase select-none">
                        Merged
                      </span>
                    </div>
                    <div className="border border-[#30363D] bg-[#161B22] p-3 rounded-md flex items-center justify-between">
                      <div className="space-y-0.5">
                        <span className="font-semibold text-xs text-[#F0F6FC] block">
                          PR #15: Create GPG validation checkpoint signatures
                        </span>
                        <span className="text-[11px] text-[#8B949E] block">
                          WaitMsBeforeAsync verification state completed
                        </span>
                      </div>
                      <span className="px-2 py-0.5 font-mono bg-[#381a54] text-purple-300 border border-purple-900/40 rounded text-[10px] font-bold uppercase select-none">
                        Review
                      </span>
                    </div>
                  </div>
