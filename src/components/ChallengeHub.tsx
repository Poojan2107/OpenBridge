...
export default function ChallengeHub({
  ...
  const [activePrSubTab, setActivePrSubTab] = useState<"conversation" | "commits" | "files">(
    "conversation",
  );
  ...
  const contributionSquares = Array.from({ length: GRID_SIZE }).map((_, idx) => {
    ...
    return {
      ...
      taskName:
        isRoadmapNode && roadmap[weekKey]?.[taskSubIndex] ? roadmap[weekKey][taskSubIndex] : null,
    };
  });
        ...
        <div className="border border-[#30363d] bg-[#0d1117] rounded-xl overflow-hidden font-sans animate-fade-in text-zinc-300">
          ...
          <div className="p-6 border-b border-[#30363d] bg-[#0d1117] space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <span
                className={`inline-flex items-center gap-1.5 p-1 px-3 rounded-full text-[10px] font-bold uppercase font-mono ${
            ...
            <div className="flex items-center gap-2 text-xs font-mono text-zinc-400 flex-wrap">
              ...
              <span className="text-zinc-400 font-sans text-[11px] font-semibold">
                {currentPr.repo}
              </span>
            </div>
          </div>
          ...
          <div className="p-6 bg-[#0d1117]">
                  ...
                  <div className="flex items-start gap-4 relative">
                    ...
                    <div className="flex-grow border border-[#30363d] rounded-lg overflow-hidden bg-[#161b22]/10">
                      ...
                      <div className="p-4 text-xs font-sans text-zinc-300 leading-relaxed space-y-2">
                        <p>
                          This adds DCO certification and pre-flight tests within the main
                          validation configurations. This fulfills step-3 milestone guidelines
                          securely.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="flex-grow border border-[#30363d] rounded-lg overflow-hidden bg-[#161b22]/10">
                        <div className="p-3 bg-[#161b22]/80 border-b border-[#30363d] flex items-center justify-between text-xs font-mono">
                          <span className="font-semibold text-zinc-350">
                            {index % 2 === 0 ? "openbridge-bot" : "lead-reviewer"}
                          </span>
                          <span className="text-zinc-500">
                            {index === 0 ? "2 hours ago" : "just now"}
                          </span>
                        </div>
                      ...
                      <div className="p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="space-y-1">
                          ...
                          <span className="block text-[11px] text-zinc-500 leading-snug">
                            1 verification check successful. This branch has absolute compliance
                            parity and is safe to merge.
                          </span>
                        </div>
            ...
            {activePrSubTab === "commits" && (
              <div className="space-y-4 animate-fade-in text-xs font-mono">
                <span className="block text-[10px] uppercase font-bold text-zinc-500 mb-2">
                  Branch Commits
                </span>
                ...
                <div className="p-3 bg-[#161b22]/40 border border-[#30363d] rounded-lg flex items-center justify-between hover:bg-[#161b22]/60 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="block font-semibold text-zinc-250">
                        ci: enforce DCO and sign-offs pre-flight validations
                      </span>
                      <span className="block text-[#8b949e] text-[10px] mt-0.5 font-sans">
                        guest-committer committed 3 hours ago
                      </span>
                    </div>
                  </div>
            ...
            {activePrSubTab === "files" && (
              <div className="space-y-4 animate-fade-in">
                <div className="flex items-center justify-between text-xs font-mono">
                  <span className="text-zinc-400 font-semibold mb-2 block">
                    1 changed file with 2 additions
                  </span>
                  <span className="text-[10px] text-emerald-400 bg-emerald-950 px-2 py-0.5 rounded border border-emerald-900 font-bold font-mono">
                    +2 -0 lines
                  </span>
                </div>
                ...
                <div className="border border-[#30363d] rounded-lg overflow-hidden bg-[#0d1117] text-[11px] font-mono">
                  ...
                  <div className="p-4 leading-relaxed text-left bg-[#050608]/40 select-text">
                    ...
                    <div className="bg-emerald-950/30 text-emerald-400 px-2 py-0.5 select-text">
                      + echo "Scanning commits for Developer Certificate of Origin (DCO)
                      approval..."
                    </div>
                    ...
                    <div className="text-zinc-400 px-2 py-0.5 select-all">{"        "}exit 1</div>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 bg-[#090a0f] border border-zinc-900 rounded-xl p-5 hover:border-zinc-800 transition-all duration-150 flex flex-col justify-between">
            <div>
              ...
              <p className="text-zinc-500 text-[11px] mt-1.5 leading-relaxed">
                Every target item you accomplish in the 4-week onboarding plan triggers a simulated
                git commit. Fill your matrix with green!
              </p>
            ...
            <div className="mt-5 pt-3 border-t border-zinc-900 text-[10px] text-zinc-500 leading-normal flex items-start gap-1.5">
              ...
              <span>
                Hover squares to trace roadmap task alignments. Toggle checkboxes inside
                "Recommended Projects & Roadmap" tab to trigger commits.
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 bg-[#0e090a] border border-orange-950/40 rounded-xl p-5 hover:border-orange-950/80 transition-all duration-150 flex flex-col justify-between">
            <div>
              ...
              <p className="text-zinc-500 text-[11px] mt-1.5 leading-relaxed">
                Hacktoberfest celebrates open source contributions. Log and validate your pull
                request URLs. Successfully registered merges qualify you for reward milestones!
              </p>
              ...
              <div className="mt-4 p-3.5 rounded bg-zinc-950/60 border border-orange-950/20">
                <div className="flex justify-between items-center text-[10px] font-mono text-zinc-400 mb-1.5">
                  ...
                  <span className="font-bold text-[#ff7900]">
                    {hacktoberfestPrCount} / 4 Registered
                  </span>
                </div>
            ...
            <div className="mt-5 border-t border-[#291712]/50 pt-3">
              <span className="block text-[8px] font-mono uppercase text-zinc-500 font-bold tracking-wider mb-2">
                My Registered PR History (Click to Review)
              </span>
                ...
                {submittedPrs.map((pr) => (
                  ...
                  >
                    <div className="min-w-0">
                      <span className="text-zinc-300 font-semibold truncate block pr-2 hover:underline">
                        {pr.title}
                      </span>
                      <span className="text-zinc-550 text-[9px] block text-left">{pr.repo}</span>
                    </div>
                    <span
                      className={`px-1.5 py-0.5 rounded text-[8px] uppercase font-bold tracking-wider shrink-0 border ${
                        pr.status === "merged"
          ...
          <div className="lg:col-span-3 bg-[#090b0e] border border-sky-950/40 rounded-xl p-5 hover:border-sky-950/80 transition-all duration-150 flex flex-col justify-between">
            <div>
              ...
              <p className="text-zinc-500 text-[11px] mt-1.5 leading-relaxed">
                Google Summer of Code has formal phases. Complete these 4 milestones to establish
                true readiness for a funded fellowship proposal.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Introduce yourself in Discord, select an issue, & find a mentor.",
                    done: completedCount >= 2,
                  },
                  {
                    label: "Draft Proposal Submit",
                    desc: "Formulate technical plan, trace affected code using Translator.",
                    done: completedCount >= 5,
                  },
                  {
                    label: "Local Sandbox Verification",
                    desc: "Fork repo, compile dependencies, & run test suites successfully.",
                    done: completedCount >= 8,
                  },
                  {
                    label: "First Live PR",
                    desc: "Submit clean commits to upstream trunk, aligning with style lines.",
                    done: completedCount >= 11,
                  },
                ].map((cp, idx) => (
                  <div
                    key={idx}
                    className="flex items-start gap-2.5 p-2 bg-[#090a0f] border border-zinc-90 w-full rounded"
                  >
                    <div
                    ...
                    <div>
                      <span
                        className={`block text-[10px] font-bold font-mono ${cp.done ? "text-sky-400" : "text-zinc-400"}`}
                      >
                        {cp.label}
                      </span>
                      <span className="block text-[9.5px] leading-relaxed text-zinc-500 font-sans">
                        {cp.desc}
                      </span>
                    </div>
                  </div>
      ...
      <div className="bg-[#090a0f] border border-zinc-900 rounded-xl p-6 space-y-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-zinc-500 text-xs mt-1 max-w-2xl leading-relaxed">
              Celebrate your onboarding milestones. Customize and generate a verified markdown badge
              status link to display proudly in your real GitHub Profile README.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="md:col-span-7 flex flex-col">
            <div
              className={`flex-grow border rounded-xl overflow-hidden relative shadow-2xl transition-all duration-300 ${
                badgeTheme === "classic"
            ...
            >
              ...
              <div
                className={`absolute top-0 right-0 w-48 h-48 rounded-full filter blur-[80px] opacity-15 pointer-events-none ${
                  badgeTheme === "classic"
                    ? "bg-blue-500"
                    : badgeTheme === "cyberpunk"
                      ? "bg-amber-500"
              ...
              <div
                className={`absolute -bottom-10 -left-10 w-36 h-36 rounded-full filter blur-[60px] opacity-10 pointer-events-none ${
                  badgeTheme === "classic"
                    ? "bg-zinc-500"
                    : badgeTheme === "cyberpunk"
                      ? "bg-red-500"
              ...
              {/* Passport Header */}
              <div
                className={`px-5 py-3.5 border-b font-mono text-center relative z-10 ${
                  badgeTheme === "classic"
              ...
              <div className="p-5 sm:p-6 relative z-10 grid grid-cols-1 sm:grid-cols-12 gap-5 items-center">
                ...
                <div className="sm:col-span-4 flex flex-col items-center justify-center text-center">
                  <div
                    className={`w-20 h-20 rounded-lg flex items-center justify-center border relative overflow-hidden select-none ${
                      badgeTheme === "classic"
                ...
                <div className="sm:col-span-8 space-y-3 font-mono">
                  ...
                  <div>
                    <span className="block text-[8px] text-zinc-555 uppercase tracking-wide">
                      Committer / Passholder
                    </span>
                    <input
                      type="text"
                      value={tempPassName}
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-[11px] leading-relaxed">
                    ...
                    <div>
                      <span className="block text-[8px] text-zinc-550 uppercase">
                        Roadmap Tasks
                      </span>
                      <span className="text-zinc-300">{completedCount} / 12 Commits</span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1 text-[9px]">
                      {profile?.skills && profile.skills.length > 0
                        ? profile.skills.map((s, idx) => (
                            <span
                              key={idx}
                              className="bg-zinc-90 border border-zinc-800 rounded px-1.5 py-0.5 text-zinc-400"
                            >
                              {s}
                            </span>
                          ))
              ...
              <div className="p-3 bg-black/60 border-t border-zinc-90 text-[8.5px] font-mono text-zinc-550 flex flex-col sm:flex-row items-center justify-between gap-1 select-all relative z-10">
                ...
                <span className="truncate max-w-xs md:max-w-md">
                  SHA256: 4e9d6bc0f50dfa213e4b{completedCount}
                  812ae93bd20f9a2e37e90c885cf34612ce00befb15
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-5 flex flex-col justify-between">
            <div className="space-y-4">
              <span className="block text-[10px] font-mono uppercase tracking-wider text-zinc-500 font-bold">
                Embed Codes For GitHub Markdown
              </span>
            ...
            <div className="mt-6 border-t border-zinc-900 pt-4 text-[10px] text-zinc-500 leading-relaxed font-mono">
              <span className="text-zinc-400 font-bold block shrink-0 select-none mb-1">
                💡 Real MVP Placement Tip:
              </span>
              <p>
                Add this Markdown code inside your repository fork README. When reviewers visit your
                profile, the verified badge demonstrates that your workspace setup has been fully
                compliance-tested under open-source regulations. Perfect for standing out in GSoC
                evaluations!
              </p>
            </div>
          </div>
